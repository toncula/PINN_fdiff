...
model = torch.load('../pinn_lstm_saves/model_pinn.pt')
model_mlp = torch.load('../pinn_lstm_saves/model_lstm.pt')
...
model = torch.load('../pinn_lstm_saves 10/model_pinn.pt')
model_mlp = torch.load('../pinn_lstm_saves 10/model_lstm.pt')
...
model = torch.load('../pinn_lstm_saves -10/model_pinn.pt').to(device)
model_mlp = torch.load('../pinn_lstm_saves -10/model_lstm.pt').to(device)
...
model = torch.load('../pinn_lstm_saves -20/model_pinn.pt').to(device)
model_mlp = torch.load('../pinn_lstm_saves -20/model_lstm.pt').to(device)
