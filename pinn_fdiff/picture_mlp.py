...
model = torch.load('pinn_fdiff/pinn_change_new_saves -20deg/model_pinn.pt',weights_only=False).to(device)
model_mlp = torch.load(
    "pinn_fdiff/pinn_change_new_saves -20deg/model_mlp.pt", weights_only=False
).to(device)
save_dir = 'pinn_fdiff/pinn_change_new_saves -20deg'
save_dir = os.path.join(save_dir)
validation_dataset = MatDNNDataset(
    "data/Panasonic 18650PF Data/-20degC/Drive cycles/06-23-17_23.35 n20degC_HWFET_Pan18650PF.mat"
)
