...
model = torch.load('pinn_lstm_saves/model_pinn.pt').to(device)
model_mlp = LSTM(input_size,hidden_size,num_layers,1)
model_mlp = torch.load('pinn_lstm_saves/model_lstm.pt').to(device)
