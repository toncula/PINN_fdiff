...
hidden_size = 32
learning_rate = 0.001
save_dir = 'pinn_rnn_saves 0degC LA92'
...
save_dir = 'pinn_rnn_saves 10degC LA92'
save_dir = os.path.join(save_dir)
setup_seed(seed)
if not os.path.exists(save_dir):
     os.mkdir(save_dir)
...
validation_dataset = MatDNNDataset("data/Panasonic 18650PF Data/10degC/Drive Cycles/03-27-17_09.06 10degC_HWFET_Pan18650PF.mat",sequence_length)
train_loaders = list()
for d in train_datasets:
    temp = DataLoader(dataset=d, batch_size=batch_size, shuffle=True)
    train_loaders.append(temp)
...
train_files = [
               ...
               "06-14-17_13.12 n10degC_NN_Pan18650PF.mat",
    "06-07-17_08.39 n10degC_UDDS_Pan18650PF.mat",
    "06-07-17_08.39 n10degC_US06_Pan18650PF.mat"
              ]
train_datasets = list()
for f in train_files:
    temp = MatDNNDataset(dataset_dir + f,sequence_length)
...
validation_dataset = MatDNNDataset("data/Panasonic 18650PF Data/-10degC/Drive Cycles/06-07-17_08.39 n10degC_HWFET_Pan18650PF.mat",sequence_length)
train_loaders = list()
for d in train_datasets:
    temp = DataLoader(dataset=d, batch_size=batch_size, shuffle=True)
    train_loaders.append(temp)
...
learning_rate = 0.001
save_dir = 'pinn_rnn_saves -20degC LA92'
save_dir = os.path.join(save_dir)
setup_seed(seed)
if not os.path.exists(save_dir):
     os.mkdir(save_dir)
...
train_files = [
               ...
               "06-23-17_23.35 n20degC_NN_Pan18650PF.mat",
